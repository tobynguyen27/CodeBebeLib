package dev.tobynguyen27.codebebelib.raytracer;
...
public class RayTracer {
    ...
    public static BlockHitResult retrace(
            Player player, double reach, ClipContext.Block blockMode, ClipContext.Fluid fluidMode) {
        Vec3 startVec = getStartVec(player);
    ...
    public static double getBlockReachDistance(Player player) {
        return player.level.isClientSide
                ...
                : player instanceof ServerPlayer ? getBlockReachDistance_server((ServerPlayer) player) : 5D;
    }
