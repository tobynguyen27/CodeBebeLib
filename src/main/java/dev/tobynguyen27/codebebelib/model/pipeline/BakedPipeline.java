 ...
 * usually this is some form of {@link io.github.fabricators_of_create.porting_lib.model.BakedQuadBuilder}, or {@link Quad} can also pack things.
...
public class BakedPipeline implements ISmartVertexConsumer {
    ...
    public static class Builder {
         ...
         * @return The same builder.
         */
        public <T extends IPipelineConsumer> Builder addFirst(
                String name, IPipelineElementFactory<T> factory, boolean defaultState, Consumer<T> defaultsSetter) {
         ...
         * @return The same builder.
         */
        public <T extends IPipelineConsumer> Builder addElement(
                String name, IPipelineElementFactory<T> factory, boolean defaultState, Consumer<T> defaultsSetter) {
            PipelineElement<T> element = makeElement(name, factory, defaultState);
            defaultsSetter.accept(element.consumer);
        ...
        private <T extends IPipelineConsumer> PipelineElement<T> makeElement(
                String name, IPipelineElementFactory<T> factory, boolean defaultState) {
