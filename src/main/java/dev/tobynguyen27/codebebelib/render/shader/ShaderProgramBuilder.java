...
import dev.tobynguyen27.codebebelib.render.shader.ShaderObject.ShaderType;
...
public class ShaderProgramBuilder {
        ...
        public ShaderObjectBuilder uniform(String name, UniformType type) {
            ...
            if (uniform != null && uniform.type() != type)
                throw new IllegalArgumentException(
                        "Uniform with name '" + name + "' already exists with a different type: " + uniform.type());
    ...
    public class BinaryShaderObjectBuilder extends ShaderObjectBuilder {
        ...
        protected ShaderObject build() {
            ...
            return new BinaryShaderObject(
                    name, assetSource, type, binaryType, entryPoint, allUniforms.values(), specializationCallback);
        }
    }
}
